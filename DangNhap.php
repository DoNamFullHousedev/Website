<?php
// Khối PHP cơ bản để xử lý dữ liệu đăng nhập
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $email    = $_POST['email'] ?? '';
    $password = $_POST['password'] ?? '';
    
    // Thêm logic truy vấn Database để kiểm tra thông tin đăng nhập tại đây
    // Ví dụ: Tạo $_SESSION['user_id'] nếu thành công
}
?>
<!DOCTYPE html>
<html lang="vi">
