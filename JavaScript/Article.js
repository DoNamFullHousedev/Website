/* =========================================================================
        ...
        // Ví dụ để thử nghiệm nhanh, bạn có thể đổi tạm thành:
        //   const currentUser = { id: 'user_le_thi_huong', role: 'user' };  // chủ của comment c1
        //   const currentUser = { id: 'admin_nguyen_minh_tuan', role: 'admin' };
        ...
        function applyCommentFormGate() {
            ...
            if (!currentUser && note) {
                note.innerHTML = '⚠️ Bạn cần <a href="../../../DangNhap.html" style="color:#3b7dd3;font-weight:600;">đăng nhập</a> để gửi bình luận.';
            }
        }
